...
class Dog:
    ...
    def info(self):
        print(f'Suņa vārds {self.name} viņam ir {self.age} gadi un suņa cena ir {self.cena} suņa krāsa {self.color} sver{self.weight}')
    ...
    def sacensibas(self,vieta,pilseta):
        ...
        print(f'Suns {self.name} piedalījās sacensībās {self.pilseta} un ieguva {self.vieta} vietu')
